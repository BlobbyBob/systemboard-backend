...
class Authentication implements MiddlewareInterface
{
    ...
    {
        $response = new Response(200, new Headers(["Access-Control-Allow-Origin" => "*", "Access-Control-Allow-Methods" => "GET, PUT, POST, DELETE", "Access-Control-Allow-Headers" => "Authorization"]));
        ...
        return $handler->handle($request)->withHeader("Access-Control-Allow-Origin", "*")->withHeader("Access-Control-Allow-Methods", "GET, PUT, POST, DELETE")->withHeader("Access-Control-Allow-Header", "Authorization");
    }
}